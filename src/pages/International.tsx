  ...
  return (
    <>
      ...
      <Section>
        ...
        <ThirdHeading>
          Somos Reconhecidos e Registrados no{' '}
          <Strong>Conselho Internacional de Dança, orgão da UNESCO</Strong>
        </ThirdHeading>
      </Section>
      ...
      <Section>
        ...
        <Wrapper>
          <Container>
            <MidBox>
              <FourthHeading>
                Universidade de Artes da Carolina do Norte - Estados Unidos
              </FourthHeading>
              <Span>2018</Span>
            ...
            <MidBox>
              <FourthHeading>
                Summer Intensive Programa National Ballet Academy New York -
          ...
          <Box>
            <FourthHeading>
              Summer Intensive Programa National Ballet Academy Denver -
              Intercâmbio de 1 mês nos Estados Unidos
            </FourthHeading>
            ...
            <Observation>
              Leticia Vieira recebeu bolsas de Estudos para o Programa Treeine
              com duração de 1 ano. ( Morou de 2018 a 2019 nos EUA)
            </Observation>

            <Span>2018</Span>
            <Student>20 bolsas de estudos</Student>
            <Observation>
              Jessica Vieira recebeu bolsas de Estudos para o Programa Treeine
        ...
        <Wrapper>
          <Container>
            ...
            <MidBox>
              <FourthHeading>
                Brussel International Ballet - Bélgica
              </FourthHeading>
